  ...
  template: `
    <div class="space-y-6">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400">VAT and tax compliance reporting</p>
      </div>
      ...
      <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-blue-700 dark:text-blue-300">Tax reporting features are being developed and will be available soon.</p>
          </div>
        </div>
      </div>
    </div>
